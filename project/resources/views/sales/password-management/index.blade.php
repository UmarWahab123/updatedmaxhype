                ...
                <div class="bulk-add-gemstone-col">
                  <div class="bulk-add-gemstone text-center w-75">
                    ...
                    <form id="change-password-form">
                      ...
                      <span class="text-left d-none" id="not_matched_error" role="alert" style="color:red;margin-top:-15px;"><strong>Password and confirm password not matched.</strong></span>
                      <br>                       
...
<script type="text/javascript">
  ...
  $("#old_password").on("focusout",function(){
    ...
    $.ajaxSetup({
     ...
     $.ajax({
        url: "{{ url('sales/check-old-password') }}",
        method: 'post',
        dataType:'json',
