                  ...
                  <div class="bulk-add-gemstone text-center w-75">
                    ...
                    <form id="profileSettingForm" enctype="multipart/form-data" method="POST">
                     ...
                     {{--  <div class="custom-file mb-5">
                      ...
                      <a href="{{url('public/uploads/sales/images/'.$user_detail->image)}}"><img src="{{url('public/uploads/sales/images/'.$user_detail->image)}}"  width="100" class="img-rounded" align="center"></a>
                      </label>
                      </div>             
                      @endif
