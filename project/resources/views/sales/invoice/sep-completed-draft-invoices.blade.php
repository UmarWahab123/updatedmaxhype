  ...
  <div class="col-md-12">
    ...
    <ol class="breadcrumb" style="background-color:transparent; font-size: 20px; color: blue !important;">
        ...
        @endif
          ...
          <li class="breadcrumb-item"><a href="{{route('draft_invoices')}}">My Draft Invoices</a></li>
            @elseif(Auth::user()->role_id != 9 && Auth::user()->role_id != 2)
          <li class="breadcrumb-item"><a href="{{route('draft_invoices')}}">All Draft Invoices</a></li>
            @endif
          <li class="breadcrumb-item active">Draft Invoice</li>
      </ol>
  </div>
</div>
...
<div class="row mb-3">
  <!-- <div class="col-lg-8 col-md-6 title-col">
    <h5 class="maintitle text-uppercase fontbold mb-0">Draft Invoice # <span class="c-ref-id">{{$order->status_prefix}}-{{$order->ref_prefix}}{{$order->ref_id }}</span></h5>
  </div> -->
  ...
  <div class="col-lg-12 col-md-12">
    <div class="row">
      <div class="col-lg-8 col-md-6 title-col mb-3">
        <h5 class="maintitle text-uppercase fontbold mb-0">Draft Invoice # <span class="c-ref-id">{{$order->status_prefix}}-{{$order->ref_prefix}}{{$order->ref_id }}</span></h5>
      </div>
    ...
    <div class="d-flex align-items-center mb-0">
      <div class="phone__div">
        ...
        <div class="form-group">
          <label class="mb-1 font-weight-bold">Draft Invoice Issue Date:</label> <span class="dblclk-edit memo-date" data-type="date_picker">{{ Carbon::parse($order->converted_to_invoice_on)->format('d/m/Y') }}</span>
        </div>

         <div class="form-group">
          <label class="mb-1 font-weight-bold">Order Status:</label> <span class="dblclk-edit memo-date order_status" data-type="date_picker">{{ @$order->statuses->title }}</span>
        </div>
        <div class="form-group">
  ...
  <div class="customer-addresses phone__div">
        ...
        <ul class="d-flex list-unstyled">
          ...
          @if($billing_address->billing_email != '-')
      ...
      <li><b>Tax ID:</b> @if($billing_address->tax_id !== null) {{ $billing_address->tax_id }} @endif</li>
        ...
        <ul class="d-flex list-unstyled">
          ...
          <span class="pl-4 pt-2 inputDoubleClick" id="delivery_request_date_span" data-fieldvalue="{{$delivery_request_date}}">
            ...
            @else
            <p>@if(!array_key_exists('delivery_request_date', $global_terminologies))Delivery Request Date @else {{$global_terminologies['delivery_request_date']}} @endif Here</p>
            @endif
          </span>
          <input type="text" class="ml-4 mt-2 d-none delivery_request_date fieldFocus" name="delivery_request_date" id="delivery_request_date" value="{{$delivery_request_date}}">
        </ul>
  ...
  <!--   <input type="text" class="ml-4 mt-2 d-none memo fieldFocus" name="memo" id="memo" value="{{@$order->memo}}"> -->
        ...
        <ul class="d-flex mb-0 list-unstyled mb-2">
          <li class=" fontbold" style="width: 180px;">Order Warehouse:</li>
        ...
        <div class=" @if(array_key_exists(7, $print_prefrences) && $print_prefrences[7]['status'] != '1') d-none @endif">
         <ul class="d-flex list-unstyled">
          ...
          <div style="width: 40%; margin-left: 25px">
            <select class="form-control sales_person state-tags mb-2" name="sales_person" id="sales_person_select" {{@$order->primary_status == '37' ? 'disabled' : ''}}>
    ...
    @if(@$order->primary_status != 37)
      <div class="col-lg-12 col-md-12 text-uppercase fontbold">
        ...
        <a href="javascript:void(0);">
          <button type="button" class="btn text-uppercase purch-btn headings-color mr-2 btn-color export-pdf d-none">Delivery Bill</button>
        </a>
        <a href="javascript:void(0);">
        ...
        <a href="javascript:void(0);">
          <!-- <button type="button" class="btn-color btn text-uppercase purch-btn headings-color export-pick-instruction mr-2">print pick instruction</button> -->
        ...
        @endif
         ...
         {{-- <a href="javascript:void(0);">
          <button type="button" class="btn text-uppercase purch-btn headings-color  btn-color export-pdf ">Print Pro-Forma</button>
        </a> --}}
        <div class="pull-right">
          @if($checkDocs > 0)
            @php $show = ""; @endphp
         ...
         <!--  <a href="javascript:void(0)" data-id="{{$order->id}}" class="download-documents">
          ...
          <span class="vertical-icons draft_invoice_copy_btn" title="Copy & Update">
    ...
    <div class="entriesbg bg-white custompadding customborder table-responsive">
          ...
          @if($order->primary_status != 37)
           <div class="col-6 pad mt-2 mb-3">
            ...
            <div class="col-12 pad mt-4 mb-4">
              ...
              <a class="btn purch-add-btn mt-3 fontmed col-3 btn-sale iphone__print__btn" id="addProduct">Add Product </a>
              <!-- <a class="btn purch-add-btn mt-3 fontmed col-2 btn-sale" id="uploadExcelbtn">Upload Excel</a> -->
              <a class="btn purch-add-btn mt-3 fontmed col-3 btn-sale iphone__print__btn" id="addInquiryProductbtn" type="submit">Add New Item</a>
                    ...
                    <div class="ship_body">
                        @if($shipping_address != null)
                            ...
                            <ul class="d-flex list-unstyled">
                                ...
                                @if($shipping_address->billing_email !='-')
            ...
            <div class="text-center confirm-btn mt-4 col-lg-12">
             ...
             @if($order->primary_status == 1 && $order->status == 6)
              ...
              @else
               ...
               <!-- <a type="submit" class="btn purch-add-btn ml-auto mr-1 draft_invoice_copy_btn" style="font-size: 10px;">Copy & Update</a> -->

              @if($has_warehouse_account == 1 && $order->primary_status != 37)
             <a type="submit" data-id="{{ $order->id }}" class="btn purch-add-btn ml-auto mr-1 confirm-draft-inv">Confirm Draft Invoices</a>
      ...
      <div class="row">
              <div class="col-lg-7 col-md-6">
                ...
                <table class="table-order-history entriestable table table-bordered text-center" style="width: 100px;font-size: 12px;">
              ...
              <div class="col-lg-5 col-md-6">
                <div class="purchase-order-detail pt-2 pb-3 pr-3 pl-3 h-100  table-responsive">
...
<!-- export pdf form starts -->
  <form class="export-pi-form" method="post" action="{{url('sales/export-draft-pi/'.$id)}}">
    @csrf
...
@if(Auth::user()->role_id)
  <script type="text/javascript">
    ...
    // $('.export-pi-form')[0].submit();
     ...
     var url = "{{url('sales/export-draft-pi')}}"+"/"+orders+"/"+page_type+"/"+column_name+"/"+sort;
...
<script type="text/javascript">
  ...
  /*$( document ).ready(function() {
    ...
    else
    {
     ...
     $(document).on('click','.draft_invoice_copy_btn',function(e){
      e.preventDefault();
      var order_id = '{{$id}}';
      var _token = $('input[name="_token"]').val();
       ...
       swal({
      title: "Alert!",
      text: "Are you sure you want to create COPY of this Draft Invoice ?",
      type: "info",
  ...
  $(document).on('click','.confirm-draft-inv', function(e){
    var order_id  = $(this).data('id');   //order id
    var page_info = "draft";
    swal({
      title: "Are you sure!!!",
    ...
    function (isConfirm) {
      if (isConfirm) {
        ...
        $.ajax({
          ...
          // url: "{{ route('confirm-order-pick-instruction-from-draft-invoice') }}",
          beforeSend: function(){
            $('#loader_modal').modal({
                backdrop: 'static',
                keyboard: false
            ...
            $("#loader_modal").modal('show');
            $(".confirm-draft-inv").attr('disabled',true);
          },
          success: function(response){
            ...
            if(response.success === true)
            {
              ...
              window.location.href = "{{ url('/sales/get-completed-invoices-details')}}/"+order_id;
            }
            if(response.success === false && response.type == 'stock')
            {
              $("#loader_modal").modal('hide');
              if(response.stock_qty == 'less_than_order')
              {
                toastr.error('Error!', 'Stock QTY is less Than Order QTY for '+response.product+'',{"positionClass": "toast-bottom-right"});
              }
              if(response.stock_qty == 'less_than_zero')
              {
                toastr.error('Error!', 'Stock QTY is less Than Zero for '+response.product+'',{"positionClass": "toast-bottom-right"});
              }
              if(response.stock_qty == 'equals_to_zero')
              {
                toastr.error('Error!', 'Stock QTY is Equal To Zero for '+response.product+'',{"positionClass": "toast-bottom-right"});
              }
            }
            if(response.success === false && response.type == 'available')
            {
              $("#loader_modal").modal('hide');
              if(response.available_qty == 'less_than_order')
              {
                toastr.error('Error!', 'Available QTY is less Than Order QTY for '+response.product+'',{"positionClass": "toast-bottom-right"});
              }
              if(response.available_qty == 'less_than_zero')
              {
                toastr.error('Error!', 'Available QTY is less Than Zero for '+response.product+'',{"positionClass": "toast-bottom-right"});
              }
              if(response.available_qty == 'equals_to_zero')
              {
                toastr.error('Error!', 'Available QTY is Equal To Zero for '+response.product+'',{"positionClass": "toast-bottom-right"});
              }
            }
            ...
            // else
            // {
            //   toastr.success('Success!', 'Other Created Successfully.',{"positionClass": "toast-bottom-right"});
            //   window.location.href = "{{ url('sales/others')}}";
            // }
    ...
    $.ajax({
          ...
          success: function(response){
            ...
            else if (response.status == 2)
            {
                ...
                $('#loader_modal').modal('hide');
            $(".confirm-draft-inv").attr('disabled',false);

                if (response.already_confirmed == true) {
                    toastr.info('Info!', 'Invoice Already Confirmed.',{"positionClass": "toast-bottom-right"});
                }
                if(response.success === true)
                {
                  toastr.success('Success!', 'Invoice Created Successfully.',{"positionClass": "toast-bottom-right"});
                  // window.location.href = "{{ url('sales/invoices')}}";
                  window.location.href = "{{ url('/sales/get-completed-invoices-details')}}/"+{{ $order->id }};
                }
                if(response.success === false && response.type == 'stock')
                {
                  $("#loader_modal").modal('hide');
  ...
  $(document).on("change focusout","#delivery_request_date, #payment_due_date, #target_ship_date",function(e) {
    ...
    $('.edit_customer').on("click",function(){
      var status = "{{@$order->primary_status}}";
      // alert(status);
      if(status == 37)
      {
        toastr.info('Sorry!', 'Cannot edit customer in manual order !!!.' ,{"positionClass": "toast-bottom-right"});
        return false;
      }
 ...
 var default_sort = null;
  ...
  $('.sorting_filter_table').on('click',function(){
    ...
    // "bAutoWidth": true,
      ...
      paging: false,
       ...
       "columnDefs": [
        ...
        { className: "dt-body-left", "targets": [ 1,2,3,4,5,6,7,8,9] },
        { className: "dt-body-right", "targets": [10,11,12,13,14,16,17,18,19,20,21] }
      ],
      dom: 'lrtip',
      colReorder: true,
      scrollX: true,
   ...
   table.on( 'column-visibility.dt', function ( e, settings, column, state ) {
      ...
      $.post({
        ...
        dataType : "json",
        data : {type:'draft_invoice_product',column_id:col},
        beforeSend: function(){
          $('#loader_modal').modal({
            backdrop: 'static',
            keyboard: false
   ...
   table.on( 'column-reorder', function ( e, settings, details ) {
    ...
    dataType : "json",
    data : "type=complete_draft_product&order="+table.colReorder.order(),
    beforeSend: function(){
  ...
  $(document).on("click",".inputDoubleClick",function(){
      ...
      if(status == 37)
      {
        toastr.info('Sorry!', 'Cannot edit manual order !!!.' ,{"positionClass": "toast-bottom-right"});
        return ;
      }
        $(this).addClass('d-none');
...
$(document).on('keyup focusout','.selling_unit',function(e) {
  ...
  $(document).on('keypress keyup focusout', 'input[type=number], input[type=text], input[type=tel]', function(e){
    ...
    if((e.keyCode === 13 || e.which === 0 ) && $(this).hasClass('active')){
      ...
      if($(this).val() !== null)
      {
        // alert($(this).prev().data('fieldvalue')+' '+$(this).val());
        var product_row = $(this).parent().parent().attr('id');
        var attr_name = $(this).attr('name');
        var new_value = $(this).val();
        var old_value = $(this).prev().html();
    ...
    if(field_name != 'unit_price'){
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          // table.columns.adjust();
          $('#loader_modal').modal('hide');
          if(data.po_created == true)
          {
            toastr.error('Error!', 'Cannot Change Supply From Because PO For This Item Is Created!' ,{"positionClass": "toast-bottom-right"});
            $('.table-quotation-product').DataTable().ajax.reload();
          }
          if(data.success == true)
          {
          ...
          if(field_name == 'from_warehouse_id')
          {
...
$(document).ready(function(){
  ...
  $(document).on('click', '.add_product_to', function(e){
      ...
      $.ajax({
              method:"post",
              data:'selected_products='+input+'&quotation_id='+inv_id+'&supplier_id='+supplier_id+'&suppliers='+sup,
...
$(document).on('click','.remove-products',function(e){
         ...
         if (isConfirm){
           $.ajax({
              ...
              success:function(data){
                ...
                if(data.picked == true){
                   toastr.success('Alert!', 'Product cannot be deleted because already move to purchasing status' ,{"positionClass": "toast-bottom-right"});
                   location.reload();
                }
              }
          });
  ...
  $(document).on('click','.invoice-btn',function (e) {
    ...
    if(delivery_date == '')
    {
      swal({ html:true, title:'Alert !!!', text:'<b>Please Add Delivery Request Date!!!</b>'});
      inverror = true;
    }
...
<script>
  function backFunctionality(){
     ...
     if(history.length > 1){
       ...
       var url = "{{ url('sales/draft_invoices') }}";
