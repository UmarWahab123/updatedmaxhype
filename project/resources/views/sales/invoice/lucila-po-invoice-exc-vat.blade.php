...
<span style="text-transform: uppercase;">Purchase Order</span>
                ...
                <!-- <tr style="height: 15px;">
                 ...
                 <tr>
                  <td style="width: 80%;padding: 0px 3px 0px 25px;background-color: #ccc;border-bottom: 3px solid #ccc;border-top: 3px solid #ccc;">
                   <div style="width: 100%">
                    <table class="table" style="width: 100%;background-color: white;min-height: 115px;font-size: 14px">
                      <tbody>
                        <tr>
            ...
            <table class="table invoicetable custom_font" style="width: 100%;border-color: skyblue;border: 1px solid #ccc;">
              <thead align="center" style="background-color: #ccc;font-size: 16px !important;line-height: 0.7;">
                <tr>
                  ...
                  <th width="10%">Unit Price<br>(EXC VAT)</th>
              ...
              <tbody style="">
               ...
               @endphp
                <tr>
                  ...
                  @endphp
                  @php
                  @$order_total_at_end = @$order_total_at_end + number_format(@$result->total_price_with_vat,4,'.','');
                  ...
                  $vat_total += @$result->vat_amount_total !== null ? round(@$result->vat_amount_total,4) : (@$result->total_price_with_vat - @$result->total_price);
                  @endphp
                  <td align="right">
...
<td width="118pt" style="position: relative;">Due Date: <span style="position: absolute;margin-left: 10pt;">{{@$order->payment_due_date != null ? Carbon::parse(@$order->payment_due_date)->format('d/m/Y') : '--'}}</span>
    ...
    <td width="75pt" align="center" valign="center" style="">THB {{@$order_sub_total_at_end != 0 ? number_format(number_format(@$order_sub_total_at_end,2,'.',''),2,'.',',') : 0}}</td>
  </tr>
</table>
<table style="max-height: 124pt;" class="custom_font">
   <tr >
