              ...
              <tbody style="">
               ...
               @endphp
                <tr>
                  ...
                  <td align="right">
                    {{number_format(number_format((@$unit_price_with_vat*$num_to_multiply) - $dis_value,2,'.',''),2,'.',',')}}
                  </td>
...
<table style="max-height: 124pt;" class="custom_font">
  <tr>
    ...
    <td width="170pt" align="left"><span style="font-size: 14px;">
      ...
      @endif
      {{@$customerShippingAddress->billing_contact_name}},{{@$customerShippingAddress->billing_address}}, {{@$customerShippingAddress->billing_city}}, {{@$order->customer->language == 'en' ? @$customerShippingAddress->getstate->name : (@$customerShippingAddress->getstate->thai_name !== null ? @$customerShippingAddress->getstate->thai_name : @$customerShippingAddress->getstate->name)}}, <br>
    ...
    <td width="91.2pt" align="center" valign="center" style="">THB {{@$order_total_at_end != 0 ? number_format(number_format(@$order_total_at_end,2,'.',''),2,'.',',') : 0}}</td>
