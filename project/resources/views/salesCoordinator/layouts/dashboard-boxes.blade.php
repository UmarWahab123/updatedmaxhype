...
<div class="bg-white box2 pt-4 pb-4">
  <div class="d-flex align-items-center justify-content-center">
    ...
    <div class="title pl-2">
      <h6 class="mb-0 headings-color number-size">{{$salesCustomers}}</h6>
...
<div class="bg-white box3 pt-4 pb-4">
  <div class="d-flex align-items-center justify-content-center">
    ...
    <div class="title pl-2">
      <h6 class="mb-0 headings-color number-size">{{$salesQuotations}}</h6>
...
<div class="bg-white box5 pt-4 pb-4">
  <div class="d-flex align-items-center justify-content-center">
    ...
    <div class="title pl-2">
      <h6 class="mb-0 headings-color number-size">{{$salesInvoice}}</h6>
