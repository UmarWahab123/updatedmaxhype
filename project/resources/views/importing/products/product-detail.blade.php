...
@section('title','Product Detail | Supply Chain')
...
<div class="col-lg-5">
  <div class="bg-white pt-3 pl-2 h-100">
    <table id="example1" class="table table-responsive headings-color sales-customer-table dataTable const-font" style="width: 100%;">
      <tbody>
        <tr>
...
<div class="col-lg-4">
  ...
  <div class="bg-white pt-3 pl-2">
    <table id="example1" class="table-responsive headings-color table sales-customer-table dataTable const-font" style="width: 100%;">
      <tbody>
  ...
  <div class="bg-white mt-3 pt-3 pl-2">
    <table id="example1" class="table-responsive headings-color table sales-customer-table dataTable const-font" style="width: 100%;">
      <tbody>
        ...
        <tr>
          <td class="fontbold text-nowrap">Unit Conversion Rate <b style="color: red;">*</b></td>
          <td class="text-nowrap">
...
<div class="row mb-3">
  ...
  <div class="bg-white table-responsive">
    <table id="example1" class="table headings-color dot-dash" style="width: 100%;">
...
<div class="row mb-3"> <!-- Product supplier div -->
  ...
  <div class="col-lg-1">
    <button class="btn btn-color add-btn pull-right btns-hide" data-toggle="modal" data-target="#addProdFixedPriceModal"><i class="fa fa-plus"></i> Add</button>
  </div>
  
  </div>

  <div class="bg-white table-responsive pt-3 pl-2" style="min-height: 230px;">
    <table id="example1" class="table headings-color const-font dot-dash" style="width: 100%;">
      <thead class="sales-coordinator-thead">
        <th>Sr. #</th>
        <th>Customer # </th>
        <th>Customer Name</th>
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      // $(this).parent().parent().after('<tr><th colspan="6">asdasd</th></tr>');
      });
  });
...
$('.collapse_rows').on('click',function(){
  ...
  $('.table-product-suppliers').DataTable({
    ...
    scrollY : '90vh',
    serverSide: true,
    ajax: "{!! url('importing/get-product-suppliers-data') !!}"+"/"+prod_detail_id,
    columns: [
