...
<div class="row mb-0 headings-color">
  ...
  <div class="col-lg-4">
<h4 class="mb-1">@if(!array_key_exists('supply_from', $global_terminologies)) Supply From  @else {{$global_terminologies['supply_from']}} @endif</h4>
   </div>
  </div>
  <div class="row">
  ...
  <div class="col-lg-8">
    <p class="mb-1">PO # {{ $getPurchaseOrder->id}}</p>
  ...
  <div class="pl-2 comp-name"><p>{{ $getPurchaseOrder->PoWarehouse->name }}</p> </div>
  </div>
  <p class="mb-1">@if($getPurchaseOrder->PoWarehouse->user_details->address !== null) {{ $getPurchaseOrder->PoWarehouse->user_details->address  }} @endif</p>
  <ul class="d-flex list-unstyled">
    <li><i class="fa fa-phone pr-2"></i> 
      {{ $getPurchaseOrder->PoWarehouse->user_details->phone_no }}
    </li>
    <li class="pl-3"><i class="fa fa-envelope pr-2"></i> 
    {{ $getPurchaseOrder->PoWarehouse->email }}
    </li>
  </ul>
...
{{-- end modal code--}}
 ...
 <div class="col-lg-12 mt-3">
  ...
  <table class="table warehouse-po-porducts-details text-center table-bordered" style="width:100%">
...
<script type="text/javascript">
  ...
  $(function(e){
     $('.warehouse-po-porducts-details').DataTable({
        ...
        scrollY : '90vh',
        scrollCollapse: true,
        ajax: "{{ url('get-purchase-order-product-detail') }}"+"/"+po_id,
        columns: [
