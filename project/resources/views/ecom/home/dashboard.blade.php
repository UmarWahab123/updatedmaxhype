  ...
  <label><b>Customer Group</b></label>
   ...
   {{--  <div class="col-lg col-md-6">
    ...
    <div class="col-lg-2 col-md-6">
        <label><b>Orders Status</b></label>
        <div class="form-group">
        <select id="choice" class="font-weight-bold form-control orders_status status_filter" name="orders_status">
        <option value="">Choose Status</option>
        <option value="all">All</option>
        <option value="35">Ready To Pick</option>
...
<div class="row entriestable-row col-lg-12 pr-0 quotation" id="quotation">
  ...
  <div class="selected-item catalogue-btn-group mt-4 mt-sm-3 ml-3">
      <a href="javascript:void(0);" class="btn selected-item-btn btn-sm cancel-quotations
      deleteIcon d-none" title="Cancel"><span><i class="fa fa-times" ></i></span></a>
  ...
  <div class="col-12 pr-0">
    <div class="entriesbg bg-white custompadding customborder">
      ...
      {{--<table id="footer_table" width="100%" class="table-bordered mt-2">
        <tbody>
            <td colspan="2" style="text-align: right; padding:5px 15px 5px; font-weight: bold; font-size: 1.1rem;">Order Total For All Entries</td>
...
<script type="text/javascript">
  ...
  $(function(e){
    ...
    var getsession = window.sessionStorage.getItem('font-weight-boldform-controlorders_statusstatus_filter');
    // alert(getsession);
    if(getsession)
    {
...
$(document).on('change','.orders_status',function(){
    var selected = $(this).val();
    if($('.orders_status option:selected').val() != '')
    {
      $('#loader_modal').modal({
          backdrop: 'static',
          keyboard: false
  ...
  //    },
    ...
    scrollCollapse: true,
      ajax:{
        ...
        url:"{!! route('get-completed-quotation-ecom') !!}",
        data: function(data) {data.orders_status = $('.orders_status option:selected').val(), data.dosortby = $('.sort-by-value option:selected').val(),data.from_date = $('#from_date').val(),data.to_date = $('#to_date').val(), data.sort_order = order, data.column_name = column_name } ,
      },
      columns: [
     ...
     footerCallback: function ( row, data, start, end, display ) {
        ...
        // $( api.column(4).footer() ).html('Orders Total');
