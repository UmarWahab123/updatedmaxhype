...
<div class="row entriestable-row">
  ...
  <div class="col-lg-12 pl-0 pr-0 d-flex align-items-center mb-3"> 
    ...
    <div class="col-lg-3 d-flex mt-auto">
      ...
      <input type="button" value="Export" class="btn recived-button d-none export-btn">
    </div>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    scrollCollapse: true,
      ajax:{
        url:"{!! route('get-ecom-cancelled-data') !!}",
        data: function(data){ data.status_filter = $('.filter-dropdown option:selected').val(),data.from_date = $('#from_date').val(),data.to_date = $('#to_date').val()},
      },
      columns: [
