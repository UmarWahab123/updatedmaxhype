                  ...
                  <div class="bulk-add-gemstone text-center w-75">
                    ...
                    <form id="profileSettingForm" enctype="multipart/form-data" method="POST">
                     ...
                     {{--  <div class="custom-file mb-5">
                      ...
                      <a href="{{url('public/uploads/purchase/'.$user_detail->image)}}"><img src="{{url('public/uploads/purchase/'.$user_detail->image)}}"  width="100" class="img-rounded" align="center"></a>
                      </label>
                      </div>            
                      @else
                      <div class="custom-file" style="padding-bottom: 85px;">
                       <label class="d-block text-left">
                      <a href="{{url('public/img/profileImg.jpg')}}"><img src="{{url('public/img/profileImg.jpg')}}"  width="100" class="img-rounded" align="center"></a>
                      </label>
                      </div>                   
                      @endif
