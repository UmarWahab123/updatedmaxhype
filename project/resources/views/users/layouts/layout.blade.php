...
<link href="{{asset('public/site/assets/backend/css/mobile_header.css')}}" rel="stylesheet" type="text/css">
...
<link href="{{asset('public/site/assets/backend/css/bootstrap-tagsinput.css')}}" rel="stylesheet">
...
<link href="{{asset('public/site/assets/multi-Images/css/responsive.min.css')}}" rel="stylesheet">
...
<style type="text/css">
  ...
  .choose-supplier .select2-container {
...
<div class="check_active d-none" id="check_active">
  <input type="hidden" name="" id="active_user" value="">
</div>
...
{{--<script src="{{asset('public/site/assets/backend/js/searchfield.js')}}"></script>--}}
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.12/js/select2.full.min.js"></script> -->
