...
<div class="row">
  <div class="col-md-12">
    ...
    <ol class="breadcrumb" style="background-color:transparent; font-size: 20px; color: blue !important;">
        ...
        @endif
          <li class="breadcrumb-item active">Margin Report by Sales Persons</li>
      </ol>
  </div>
</div>
...
<script type="text/javascript">
    ...
    //   processing: '<i class="fa fa-spinner fa-spin fa-3x fa-fw" style="color:#13436c;"></i><span class="sr-only">Loading...</span> '},
      ...
      //   },
        ...
        $.ajax({
          method:"get",
          dataType:"json",
          url:"{{ route('get-margin-report-3-footer') }}",
  ...
  table2.on( 'column-visibility.dt', function ( e, settings, column, state ) {
      ...
      $.post({
        ...
        dataType : "json",
        data : {type:'margin_report_by_sales',column_id:col},
        beforeSend: function(){
          $('#loader_modal').modal({
            backdrop: 'static',
            keyboard: false
...
$(document).on('click','.export-btn',function(){
    ...
    $.ajax({
      method:"get",
      url:"{{route('export-status-margin-report-by-sales')}}",
      data:{from_date_exp:from_date, to_date_exp:to_date, filter:filter, sortbyvalue:order, sortbyparam:column_name},
      beforeSend:function(){
  ...
  let type = 'margin_report_by_sales';
