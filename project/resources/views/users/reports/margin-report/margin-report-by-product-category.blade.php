...
<div class="row">
  <div class="col-md-12">
    ...
    <ol class="breadcrumb" style="background-color:transparent; font-size: 20px; color: blue !important;">
        ...
        @endif
          <li class="breadcrumb-item active">Margin Report by Product Category</li>
      </ol>
  </div>
</div>
  ...
  $(function(e){
    ...
    //   processing: '<i class="fa fa-spinner fa-spin fa-3x fa-fw" style="color:#13436c;"></i><span class="sr-only">Loading...</span> '},
      ...
      //   },
        ...
        $.ajax({
          method:"get",
          dataType:"json",
          url:"{{ route('get-margin-report-4-footer') }}",
    ...
    table2.on( 'column-visibility.dt', function ( e, settings, column, state ) {
      ...
      $.post({
        ...
        dataType : "json",
        data : {type:'margin_report_by_product_category',column_id:col},
        beforeSend: function(){
          $('#loader_modal').modal({
            backdrop: 'static',
            keyboard: false
...
$(document).on('click','.export-btn',function(){
    ...
    $.ajax({
      method:"get",
      url:"{{route('export-status-margin-report-by-product-category')}}",
  ...
  let type = 'margin_report_by_product_category';
