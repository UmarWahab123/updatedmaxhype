...
<div class="row">
  <div class="col-md-12">
    ...
    <ol class="breadcrumb" style="background-color:transparent; font-size: 20px; color: blue !important;">
        ...
        @endif
          <li class="breadcrumb-item active">Margin Report by Supplier</li>
      </ol>
  </div>
</div>
...
$("#to_date").datepicker('setDate','today');
  ...
  $(function(e){
    ...
    var table2 = $('.product-sales-report').DataTable({
      ...
      ajax: {
        ...
        url:"{!! route('get-margin-report-10') !!}",
 ...
 $(document).on('click','.export-btn',function(){
    ...
    $.ajax({
      method:"get",
      url:"{{route('export-status-margin-report-by-supplier')}}",
  ...
  let type = 'margin_report_by_supplier';
