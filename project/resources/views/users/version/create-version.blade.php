...
<div class="row align-items-center mb-3">
    <div class="col-md-10 title-col">
      <h4 class="maintitle">Create Version</h4>
    </div>    
...
<div class="row entriestable-row mt-2">
  <div class="col-12">
    <div class="bg-white custompadding customborder">
        <form action="{{ route('add-version')}}" method="POST" id="add-version-form" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <label > Version </label>
                ...
                <div class="col-md-6">
                    <label > Title </label>
                    <input type="text" name="title" id="title" class="form-control"  placeholder="Enter Version Title">
                ...
                <div class="form-group col-12">
                    ...
                    <textarea type="text" name="features" class="font-weight-bold form-control-lg form-control summernote ticket-description" id="version-features"  placeholder="Description "></textarea>
                </div>
                <div class="form-group col-12">
                    <label for="inputEmail3" class=" control-label">Bugfixes</label>
                    <textarea type="text" name="bugfixes" class="font-weight-bold form-control-lg form-control summernote ticket-description" id="version-bugfix" placeholder="Description (Required)"></textarea>
                </div>
                <div class="form-group col-12">
                    <button type="submit" class="btn btn-info float-right mt-3 submit-btn">Add</button>
                </div>
            </div>
        </form>
    </div>
