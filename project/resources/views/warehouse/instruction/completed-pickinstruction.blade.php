...
<div class="col-lg-2 d-flex align-items-center">
  <h4 class="mb-lg-auto">Pick Instructions</h4>
</div>
<div class="col-lg-3 d-flex align-items-center fontbold">
</div>
...
<div class="col-lg-3 d-flex align-items-center bg-white p-2 mr-3 ml-3">
      <table class="table table-bordered mb-0">
        <tbody>
          <tr>
...
<div class="bg-white table-responsive p-3">
  ...
  <div class="col-lg-2 col-md-3 pull-right pb-3 mt-md-2">
    <div class="input-group-append">
      <button class="btn btn-success save-and-close-btn" type="submit">Save & Close</button>  
    </div>
  </div>

  <div class="row pt-5">
    <div class="col-lg-4 col-md-4 col-sm-6 pr-4">
          <p><strong>{{$global_terminologies['comment_to_customer'] }}: </strong><span class="inv-note" style="font-weight: normal;">{{@$comment_to_customer != null ? @$comment_to_customer->note : 'No Note'}}</span></p>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-6 pr-4">
        <p><strong>Comment To Warehouse: </strong><span class="inv-note" style="font-weight: normal;">{{@$comment != null ? @$comment->note : 'No Note'}}</span></p>
    </div>
  </div>
  <div class="row pt-5">
 ...
 $(function(e){  
  ...
  table2.on( 'column-reorder', function ( e, settings, details ) {
    $.get({
      ...
      dataType : "json",
      data : "type=completed_pick_instruction_detail&order="+table2.colReorder.order(),
      beforeSend: function(){
        $('#loader_modal').modal({
          backdrop: 'static',
          keyboard: false
