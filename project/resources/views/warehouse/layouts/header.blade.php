...
<!-- <div class="col-xl-9 col-lg-8 col-md-8 col-sm-6 topsearches pr-5">
  This commented code need to be uncommented when its functionlity is created
    <div class="row pl-3">
   ...
   <ul class="align-items-center justify-content-end d-flex list-unstyled mb-0">
      <li class="nav-item dropdown prof-dropdown d-flex">
        <a class="align-items-center d-flex dropdown-toggle nav-link my_click remove-after" href="#"data-toggle="dropdown">
          <img class="mobile-bell-icon" src="{{asset('public/img/bell.png')}}" style="box-shadow: 0px 0px 4px #a9a9a9; height: 35px; width: 35px">
        ...
        <div class="dropdown-menu bell-dropdown mt-2" style="max-height: 500px; box-shadow: 0px 0px 4px #a9a9a9;top: -5px !important; width:300px; height: auto; @if($dummy_data != null && $dummy_data->count() >= 8) overflow-y:scroll; @endif">
    ...
    <li class="nav-item dropdown prof-dropdown d-flex">
      ...
      @if(@Auth::user()->user_details->image != null && file_exists( public_path() . '/uploads/warehouse/images/' . @Auth::user()->user_details->image))
        <img src="{{asset('public/uploads/warehouse/images/'.@Auth::user()->user_details->image)}}" alt="user image" class="img-fluid rounded-circle img-fluid profileimg mobile-profileimg">
...
"></i>
      ...
      <div class="dropdown-menu sale-drop" style="right: -15px;">
        ...
        @endif
        <a class="dropdown-item" href="{{route('change-password-warehouse')}}">
