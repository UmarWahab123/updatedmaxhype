...
<div class="row entriestable-row mt-3">
  <div class="col-12">
    <div class="entriesbg bg-white custompadding customborder">
      ...
      <div class="col-sm-8">
        {!! Form::open(['url' => route("store-template")]) !!}
        <div class="form-group">
          <label for="type" class="font-weight-bold">Type <span class="text-danger">*</span></label>


          {!! Form::select('type', ['create-sales' => 'Create Sales','create-purchasing'=>'Create Purchasing','create-sales-coordinator'=>'Create Sales Coordinator','create-importing'=>'Create Importing','create-warehouse'=>'Create Warehouse','create-accounting'=>'Create Accounting'], null, ['placeholder' => 'Choose a Type', 'class' => 'form-control '.($errors->has('type') ? 'is-invalid':'') , 'id' => 'type']) !!}
        ...
        <div class="form-group">
          ...
          {!! Form::textarea('content', $value = null, ['class' => 'form-control '.($errors->has('content') ? 'is-invalid':''), 'placeholder' => 'Content', 'id' => 'content']) !!}
