...
@section('title','Purchasing Management | Supply Chain')
...
{{-- <div class="row mb-0">
  <div class="col-md-12 title-col">
    <div class="d-sm-flex justify-content-between">
      <h4 class="text-uppercase fontbold">PURCHASING</h4>
      <div class="mb-0">
...
<div class="row align-items-center mb-3">
  <div class="col-md-8 title-col">
      <h4 class="maintitle">PURCHASING</h4>
  </div>    
...
<div class="row entriestable-row mt-2">
  <div class="col-12">
    ...
    <div class="table-responsive">
          <table class="table entriestable table-bordered table-purchasing text-center">
              <thead>
                  <tr>
                      <th>Action</th>
                      <th>Name</th>
...
<div class="modal fade" id="addPurchasingModal">
    <div class="modal-dialog modal-dialog-centered parcelpop">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body text-center">
          <h3 class="text-capitalize fontmed">Add Purchasing</h3>
          <div class="mt-5">
          {!! Form::open(['method' => 'POST', 'class' => 'add-purchasing-form']) !!}
...
<script type="text/javascript">
  $(function(e){
    ...
    $(document).on("focus", ".datepicker", function(){
     ...
     $('.table-purchasing').DataTable({
         processing: true,
        "language": {
            processing: '<i class="fa fa-spinner fa-spin fa-3x fa-fw" style="color:#13436c;"></i><span class="sr-only">Loading...</span> '},
        ordering: false,
        serverSide: true,
        ajax: "{!! route('get-purchasing') !!}",
        columns: [
    ...
    $(document).on('click', '.save-btn', function(e){
      ...
      $.ajaxSetup({
       ...
       $.ajax({
          url: "{{ route('add-purchasing') }}",
          method: 'post',
          data: $('.add-purchasing-form').serialize(),
          beforeSend: function(){
          ...
          success: function(result){
            ...
            if(result.success === true){
              $('.modal').modal('hide');
              toastr.success('Success!', 'purchasing added successfully',{"positionClass": "toast-bottom-right"});
              $('.add-purchasing-form')[0].reset();
              setTimeout(function(){
