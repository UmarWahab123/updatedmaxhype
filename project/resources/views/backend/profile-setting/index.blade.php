                  ...
                  <div class="bulk-add-gemstone text-center w-75">
                    ...
                    <form id="profileSettingForm" enctype="multipart/form-data" method="POST">
                     ...
                     {{--  <div class="custom-file mb-5">
                      ...
                      <a href="{{url('public/uploads/admin/images/'.@$user_detail->image)}}"><img src="{{url('public/uploads/admin/images/'.@$user_detail->image)}}"  width="100" class="img-rounded" align="center"></a>
                      </label>
                      </div>                      
                      @endif
...
$(document).on('submit', '#profileSettingForm', function(e){
  ...
  if(error == false){
   $.ajax({
      url: "{{ route('admin-update-profile-setting') }}",
      method: 'post',
      data:formData,
      cache: false,
      contentType: false,
