...
<div class="row align-items-center mb-3">
  <div class="col-md-8 title-col">
    <h3 class="maintitle">Draft Invoices</h3>
  </div>
  ...
  <div class="d-flex dropdown justify-content-end show">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
      ...
      <a class="dropdown-item" href="{{route('pending-quotations')}}">@if(!array_key_exists('unfinished_quotation', $global_terminologies)) Unfinished Quotation @else {{$global_terminologies['unfinished_quotation']}} @endifs</a>
    </div>
  </div>
  </div>
</div>
