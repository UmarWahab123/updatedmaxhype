...
<div class="row align-items-center mb-3">
  <div class="col-md-8 title-col">
    <h3 class="maintitle text-uppercase fontbold">@if(!array_key_exists('unfinished_quotation', $global_terminologies)) Unfinished Quotation @else {{$global_terminologies['unfinished_quotation']}} @endifs</h3>
  </div>

  <div class="col-md-4 text-right title-right-col">
  <div class="d-flex dropdown justify-content-end show">
    <a class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      Unfinished Quotations <i class="fa fa-angle-down" aria-hidden="true"></i>
    </a>
