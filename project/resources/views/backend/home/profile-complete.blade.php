...
<div class="row align-items-center mb-3">
  <div class="col-md-8 title-col">
    <h3 class="maintitle">Complete your profile</h3>
  </div>
</div>
...
<div class="row mb-3 justify-content-center ">
      ...
      <!-- multistep form -->
    <form id="complete-profile-form_1"  class="sign-form" enctype="multipart/form-data">
...
$(document).on('submit', '#complete-profile-form_1', function(e){
  // alert('here');
  e.preventDefault();
  ...
  $.ajaxSetup({
   ...
   $.ajax({
      url: "{{ url('admin/admin-complete-profile') }}",
      method: 'post',
      data:formData,
      cache: false,
      contentType: false,
