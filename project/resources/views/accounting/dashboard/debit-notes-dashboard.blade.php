  ...
  <div class="col-md-12">
    ...
    <ol class="breadcrumb" style="background-color:transparent; font-size: 20px; color: blue !important;">
        ...
        @endif
          ...
          <li class="breadcrumb-item active">Debit Notes Dashboard</li>
      </ol>
  </div>
</div>
...
<div class="col-lg-12 headings-color">
  ...
  <div class="row">
    ...
    <div class="col-lg col-md-6" id="quotation-1">
      <div class="form-group">
        <select class="form-control selecting-tables sort-by-value">
            <option value="1" selected="true">-- Debit Notes --</option>
    ...
    <div class="col-2" id="debit_person">
        <div class="form-group">
          <select class="font-weight-bold form-control-lg form-control js-states state-tags debit_person_select" name="credit_person" required="true">
              <option value="">Choose Debit Person</option>
    ...
    <!--  <div class="col-lg col-md-6" id="Choose-customer">
     ...
     <div class="col-lg col-md-6" id="customer-group">
      <div class="form-group">
    ...
    <div class="col-lg col-md-6 ml-md-auto mr-md-auto pb-md-3" id="reset-button">
      <div class="input-group-append ml-3">
              <!--   <span class="reset common-icons" title="Reset">
          <img src="{{asset('public/icons/reset.png')}}" width="27px">
        </span>   -->
...
<div class="row entriestable-row col-lg-12 pr-0 quotation" id="quotation">
  ...
  @else
  <div class="col-12 pr-0">
    <div class="entriesbg bg-white custompadding customborder table-supplier-debit-note_div">
          <!-- Supplier Debit Note Table-->
          <table class="table entriestable table-bordered table-supplier-debit-note text-center">
              <thead>
                  <tr>
                      <th>Action</th>
                      <th>Order#
...
$('.sorting_filter_table').on('click',function(){
  ...
  $('#from_date').change(function() {
    ...
    $('.table-quotation').DataTable().ajax.reload();
    $('.table-supplier-debit-note').DataTable().ajax.reload();
      $($.fn.dataTable.tables(true)).DataTable()
        .columns.adjust();
  });
   ...
   $('.table-supplier-debit-note').DataTable({
            "sPaginationType": "listbox",
            processing: false,
            ordering: false,
            searching:false,
        ...
        scrollCollapse: true,
            ...
            url:"{!! route('get-supplier-debit-notes') !!}",
            data: function(data) {
  ...
  $(document).on('click', '.deleteIcon, .delete_supplier_debit_icon', function(){
    // var selected_quots = [];
    ...
    var type = $('.debit_person_select').val() == '1' ? 'customer' : 'supplier';
    var id = $(this).data('id');
    swal({
      title: "Alert!",
      text: "Are you sure you want to delete this debit note ?",
      type: "info",
      ...
      if (isConfirm){
        $.ajax({
          ...
          url:"{{ route('delete-debit-note') }}",

          success:function(result){

            if(result.success == true){

              toastr.success('Success!', 'Debit Note deleted Successfully',{"positionClass": "toast-bottom-right"});
              $('.table-quotation').DataTable().ajax.reload();
              $('.table-supplier-debit-note').DataTable().ajax.reload();
            }
          }
...
$('#header_customer_search').keyup(function(event){
  ...
  $(document).on('click', function (e) {
   ...
   $(document).on('change', '.debit_person_select', function() {
    ...
    if ($(this).val() == '1') {
        ...
        // $('.table-supplier-debit-note_div').removeClass('d-none');
