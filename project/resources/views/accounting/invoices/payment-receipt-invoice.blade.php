                  ...
                  <td style="width: 50%;" align="right">
                    <p style="margin: 0px 0px 6px;">
                      ...
                      {{Auth::user()->getCompany->thai_billing_name}}
                        ...
                        ประเทศไทย, {{@Auth::user()->getCompany->getstate->thai_name}}, {{@Auth::user()->getCompany->billing_zip }}<br>
                  ...
                  <td style="">
                   <span>
                    ...
                    <td align="">
                      ...
                      {{@$tran->order->primary_status == 25 ? '-' : ''}}{{number_format(@$vat_amount_paid,2,'.',',')}}
                      @else
                      {{@$tran->order->primary_status == 25 ? '-' : ''}}{{number_format(@$total_vat,2,'.',',')}}
                      @endif
                    </td>
                  </tr>
                  @endif
