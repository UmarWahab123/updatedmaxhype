        ...
        <thead class="title" style="line-height: 0.6;background-color: #aaa;">
         <tr>
          ...
          <tr>
            ...
            <td style="text-align: left;">{{@$ref_no}}-1</td>
            <td align="" style="text-align: right;border-right: 1px solid #ccc;">{{@$order->primary_status == 25 ? '-' : ''}}{{number_format(@$vat_total,2,'.',',')}}</td>
          </tr>
          @endif
          ...
          <tr>
            ...
            <td style="text-align: left;">{{@$ref_no}}-2</td>
            <td align="" style="text-align: right;border-right: 1px solid #ccc;">{{@$order->primary_status == 25 ? '-' : ''}}{{number_format(@$non_vat_total,2,'.',',')}}</td>
          </tr>
          @endif
