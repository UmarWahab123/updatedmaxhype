...
เดบิตหมายเหตุ</span></h2>
    ...
    font-style: normal;font-size: 16px;"><strong>
                      ...
                      <span style="font-size: 18px">{{ @Auth::user()->getCompany->billing_address}},<br> {{@Auth::user()->getCompany->getstate->name.', '.@Auth::user()->getCompany->billing_zip }}
                        </span>
                    </p>
...
<table style="max-height: 124pt;" class="custom_font">
  <tr>
    ...
    <td width="45pt"></td>
    <td width="20pt" style="position: relative;"><span style="position: absolute;left: -20pt;"></span></td>
    <td width="79pt" align="right" style="line-height: 0.6;"><span>รวมเงิน</span><br>Sub Total</td>
   ...
   <tr >
    ...
    <td width="61.2pt" align="right" valign="middle" style="padding-top: 7px; padding-right: 28px">THB {{@$vat_total != 0 ? @number_format($vat_total,2,'.',',') : 0}}</td>
  </tr>
