...
<body>
  <div id="header">
    ...
    font-weight: bold;
    font-style: normal;font-size: 13px;"><strong>
                   ...
                   <div style="padding:3px 3px 3px 25px;background-color: #ccc;min-height: 115px;">
                      ...
                      <tbody>
                        <tr style="height: 50px;">
                          ...
                          <td width="60%" style="line-height: 0.8;padding-top: 15px;"> <span style="">{{@$payment->payment_reference_no}}</span> </td>
                        </tr>
                ...
                $iteration++;
                      if(@$order->in_status_prefix !== null)
                        ...
                        $non_vat_total_original = @$total_received[$i++];
                         ...
                         $vat_total = @$vat_total_original !== '' ? @$vat_total_original : 0;
                        $non_vat_total = @$non_vat_total_original !== '' ? @$non_vat_total_original : 0;
                 @endphp
                  ...
                  <td style="">
                    ...
                    <td>{{$order->delivery_request_date !== null ? Carbon::parse(@$order->delivery_request_date)->format('d/m/Y') : '--'}}</td>
