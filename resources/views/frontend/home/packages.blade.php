   ...
   <div class="container">
      ...
      <div class="row package-slider slider-button">
         <div class="col-lg-4">
            <div class="package-item">
               <div class="package-image">
                  <img src="{{asset('/frontend/images')}}/package1.jpg" alt="Image">
         ...
         <div class="col-lg-4">
            <div class="package-item">
               <div class="package-image">
                  <img src="{{asset('/frontend/images')}}/package2.jpg" alt="Image">
                  <div class="package-price">
                     <div class="deal-rating">
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
         ...
         <div class="col-lg-4">
            <div class="package-item">
               <div class="package-image">
                  <img src="{{asset('/frontend/images')}}/package3.jpg" alt="Image">
                  <div class="package-price">
                     <div class="deal-rating">
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
