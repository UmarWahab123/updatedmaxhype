                        ...
                        <div class="row">                      
                           <div class="col-md-6">
                              <div class="form-group m-form__group">
                                 ...
                                 <select name="location_country_id" class="form-control" data-option-id="{{(isset($data['results']->location_country_id ) ? $data['results']->location_country_id  : '')}}">
                           ...
                           <div class="col-md-6">
                              <div class="form-group m-form__group">
                                 ...
                                 <input type="text" name="location_city_name" class="form-control m-input m-input--square" value="{{(isset($data['results']->location_city_name) ? $data['results']->location_city_name : '')}}">
                              </div>
                           </div>
                           </div>
                           <div class="row">
